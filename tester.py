...
def run_tests(exe_path, test_folder, print_output=False):
    ...
    for stdin_path in test_files:
        ...
        parameters_string = read_file(parameters_path).strip()
        
        # Use shlex.split to correctly handle spaces within quotes
        parameters = shlex.split(parameters_string)
        
        process = subprocess.Popen([exe_path] + parameters, 
...
run_tests('/Users/gabrielkanocz/Desktop/z3_tester/z3', 's1', print_output=True)
